...
export default function Admin() {
    ...
    return (
        <div className="bg-slate-100 font-sans p-2 sm:p-6 lg:p-8 min-h-screen">
            <div className="max-w-7xl mx-auto">
                <header className="mb-8 px-2 sm:px-0">
                    ...
                    <p className="text-slate-500 mt-2 text-lg">Manage blood recipients and donors with trust and urgency.</p>
                </header>
